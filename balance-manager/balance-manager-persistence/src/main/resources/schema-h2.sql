...
CREATE SEQUENCE IF NOT EXISTS SQ_OPERATION_IDT;
...
CREATE TABLE IF NOT EXISTS ACCOUNT_OPERATION_LOCK (
	...
	IDT_OPERATION BIGINT NOT NULL,
	NUM_LOCK BIGINT NOT NULL,
	IDT_ACCOUNT BIGINT NOT NULL,
	PRIMARY KEY (IDT_ACCOUNT_OPERATION_LOCK)
);

CREATE UNIQUE INDEX IF NOT EXISTS ACCOUNT_OPERATION_LOCK_UK01 ON ACCOUNT_OPERATION_LOCK (IDT_OPERATION, IDT_ACCOUNT);
...
CREATE TABLE IF NOT EXISTS OPERATION (
	IDT_OPERATION BIGINT DEFAULT SQ_OPERATION_IDT.NEXTVAL,
	COD_OPERATION VARCHAR(32) NOT NULL,
	PRIMARY KEY (IDT_OPERATION)
);

CREATE UNIQUE INDEX IF NOT EXISTS OPERATION_UK01 ON OPERATION (COD_OPERATION);

ALTER TABLE ACCOUNT_OPERATION_LOCK ADD CONSTRAINT IF NOT EXISTS FK_OPERATION FOREIGN KEY (IDT_OPERATION) REFERENCES OPERATION(IDT_OPERATION);
