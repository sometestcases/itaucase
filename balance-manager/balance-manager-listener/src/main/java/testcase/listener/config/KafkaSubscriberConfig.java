...
public class KafkaSubscriberConfig {
    ...
    public static final String ACCOUNT_CREATION_CONTAINER_FACTORY = "accountCreationKafkaListenerContainerFactory";
    ...
    @Bean
    public ConsumerFactory<String, AccountCreated> accountCreationConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(getDefaultProperties());
    }

    @Bean(ACCOUNT_CREATION_CONTAINER_FACTORY)
    public ConcurrentKafkaListenerContainerFactory<String, AccountCreated> accountCreationListenerContainerFactory() {

        final ConcurrentKafkaListenerContainerFactory<String, AccountCreated> factory = new ConcurrentKafkaListenerContainerFactory<>();
