...
public class KafkaSubscriberConfig {
    ...
    public static final String BALANCE_UPDATE_CONTAINER_FACTORY = "balanceUpdateKafkaListenerContainerFactory";
    ...
    @Bean
    public ConsumerFactory<String, BalanceUpdate> balanceUpdateOperationConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(getDefaultProperties());
    }

    @Bean(BALANCE_UPDATE_CONTAINER_FACTORY)
    public ConcurrentKafkaListenerContainerFactory<String, BalanceUpdate> balanceUpdateListenerContainerFactory() {

        final ConcurrentKafkaListenerContainerFactory<String, BalanceUpdate> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(balanceUpdateOperationConsumerFactory());
